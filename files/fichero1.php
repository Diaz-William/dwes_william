...
<html>
    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $nombre = str_pad($nombre, 40, " ", STR_PAD_RIGHT);       // Posición 1 a 40
            $apellido1 = str_pad($apellido1, 41, " ", STR_PAD_RIGHT); // Posición 41 a 81
            $apellido2 = str_pad($apellido2, 42, " ", STR_PAD_RIGHT); // Posición 82 a 123
            $nacimiento = str_pad($nacimiento, 10, " ", STR_PAD_RIGHT); // Posición 124 a 133
            $localidad = str_pad($localidad, 27, " ", STR_PAD_RIGHT); // Posición 134 a 160
